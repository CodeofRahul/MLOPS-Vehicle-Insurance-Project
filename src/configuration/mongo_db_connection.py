    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                MongoDBClient.client = pymongo.MongoClient("mongodb+srv://420kumarahul:jkK4wR0xJ1IWnrN0@cluster0.dywc2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", tlsCAFile=ca)
